...
　　<div class="inner px-8">
		<!-- h2.c-tail ---------------------------->
		<h2 class="c-tail flex flex-row items-center bg-gray-900 pl-6 pt-3 pb-3 pr-3 mb-8 border-b-2 font-semibold text-3xl text-white">h2.c-tail</h2>

    <!-- h3.c-tail ---------------------------->
    <h3 class="c-tail border border-black pl-4 pt-2 pb-2 pr-2 mb-8 mt-12 font-bold text-3xl">基本的なやり方(pcとtb/sm)</h3>
    <div class="">
    ...
    <!-- h3.c-tail ---------------------------->
    <h3 class="c-tail border border-black pl-4 pt-2 pb-2 pr-2 mb-8 mt-12 font-bold text-3xl">レスポンシブ対応(今回はassetsの画像を読み込む)</h3>
    <div class="">
    <picture class="imgWrapper">
    ...
    <!-- h3.c-tail ---------------------------->
    <h3 class="c-tail border border-black pl-4 pt-2 pb-2 pr-2 mb-8 mt-12 font-bold text-3xl">WPタグの呼び出し(参考)</h3>
    <div class="">
    <h4 class="c-tail pl-4 py-2 text-xl font-bold relative mb-8 mt-12">wp_get_attachment_image</h4>
    <?php echo wp_get_attachment_image( 76, 'thumb-lg' ) ?>

    <h4 class="c-tail pl-4 py-2 text-xl font-bold relative mb-8 mt-12">the_post_thumbnail()</h4>
